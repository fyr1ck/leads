...
export const PIPELINE = [
  { slug: 'NOVO', nome: 'Novo', cor: '#64748b' },
  { slug: 'CONTATADO', nome: 'Contatado', cor: '#38bdf8' },
  { slug: 'RESPONDEU', nome: 'Respondeu', cor: '#3b82f6' },
  { slug: 'INTERESSADO', nome: 'Interessado', cor: '#22c55e' },
  { slug: 'DEMO', nome: 'Demonstracao', cor: '#f97316' },
  { slug: 'NEGOCIACAO', nome: 'Negociacao', cor: '#a855f7' },
  { slug: 'FECHADO', nome: 'Fechado', cor: '#14b8a6' }
];

/** Etapas fora do funil principal (spec 74). */
export const PIPELINE_EXTRA = [
  { slug: 'RECUSOU', nome: 'Recusou', cor: '#ef4444' },
  { slug: 'SEM_RESPOSTA', nome: 'Sem resposta', cor: '#475569' },
  { slug: 'REATIVACAO', nome: 'Reativacao', cor: '#eab308' }
];
export const PIPELINE_SLUGS = [...PIPELINE, ...PIPELINE_EXTRA].map((p) => p.slug);
...
export const TAGS_PADRAO = [
  { slug: 'INTERESSADO',         nome: 'Interessado',          emoji: '\u{1F7E2}', cor: '#22c55e', prioridade: 'MAXIMA', score: 85, pipeline: 'INTERESSADO', ordem: 1 },
  { slug: 'PEDIU_DEMONSTRACAO',  nome: 'Pediu demonstracao',   emoji: '\u{1F7E0}', cor: '#f97316', prioridade: 'MAXIMA', score: 88, pipeline: 'DEMO', ordem: 2 },
  ...
  { slug: 'QUER_CONTRATAR',      nome: 'Quer contratar',       emoji: '\u{1F91D}', cor: '#14b8a6', prioridade: 'MAXIMA', score: 97, pipeline: 'NEGOCIACAO',   ordem: 5 },
  { slug: 'PEDIU_INFORMACOES',   nome: 'Pediu informacoes',    emoji: '\u{2139}',  cor: '#38bdf8', prioridade: 'ALTA',   score: 70, pipeline: 'INTERESSADO', ordem: 6 },
  { slug: 'QUER_CONTATO',        nome: 'Quer contato',         emoji: '\u{1F4DE}', cor: '#60a5fa', prioridade: 'ALTA',   score: 68, pipeline: 'RESPONDEU',  ordem: 7 },
  { slug: 'FALAR_DEPOIS',        nome: 'Pediu para falar depois', emoji: '\u{1F552}', cor: '#818cf8', prioridade: 'ALTA', score: 62, pipeline: 'RESPONDEU', ordem: 8 },
  { slug: 'RESPONDEU',           nome: 'Respondeu',            emoji: '\u{1F535}', cor: '#3b82f6', prioridade: 'ALTA',   score: 55, pipeline: 'RESPONDEU',  ordem: 9 },
  { slug: 'AGUARDANDO_RESPOSTA', nome: 'Aguardando resposta',  emoji: '\u{1F7E1}', cor: '#facc15', prioridade: 'MEDIA',  score: 45, pipeline: 'RESPONDEU',  ordem: 10 },
  { slug: 'REVISAR_MANUALMENTE', nome: 'Revisar manualmente',  emoji: '\u{26A0}',  cor: '#f59e0b', prioridade: 'MEDIA',  score: 40, pipeline: 'RESPONDEU',  ordem: 11 },
  { slug: 'JA_POSSUI_SITE',      nome: 'Ja possui site',       emoji: '\u{1F310}', cor: '#94a3b8', prioridade: 'BAIXA',  score: 25, pipeline: 'RESPONDEU',  ordem: 12 },
  { slug: 'NAO_INTERESSADO',     nome: 'Nao interessado',      emoji: '\u{1F534}', cor: '#ef4444', prioridade: 'BAIXA',  score: 10, pipeline: 'RECUSOU',  ordem: 13 },
  { slug: 'RECUSOU',             nome: 'Recusou',              emoji: '\u{274C}',  cor: '#dc2626', prioridade: 'BAIXA',  score: 5,  pipeline: 'RECUSOU',  ordem: 14 },
  { slug: 'SEM_RESPOSTA',        nome: 'Sem resposta',          emoji: '\u{26AB}',  cor: '#64748b', prioridade: 'BAIXA',  score: 15, pipeline: 'SEM_RESPOSTA', ordem: 15 }
];
...
/**
 * Temperatura do lead pelo score (spec 60 / 61).
 * 90-100 quente | 70-89 morno | 40-69 frio | 0-39 gelado
 */
export function faixaPotencial(score = 0) {
  const s = Number(score) || 0;
  if (s >= 90) return { faixa: 'QUENTE', nome: 'Quente', emoji: '🔥', cor: '#f97316' };
  if (s >= 70) return { faixa: 'MORNO', nome: 'Morno', emoji: '🟠', cor: '#fb923c' };
  if (s >= 40) return { faixa: 'FRIO', nome: 'Frio', emoji: '🟡', cor: '#facc15' };
  return { faixa: 'GELADO', nome: 'Gelado', emoji: '🔴', cor: '#ef4444' };
}

export const temperatura = (score) => faixaPotencial(score).faixa;
